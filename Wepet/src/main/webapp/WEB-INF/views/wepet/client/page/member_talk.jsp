            ...
            <div class="layout-page"> <!-- Layout-page -->
                <div class="content-wrapper"> <!-- Content wrapper -->
                    <div class="container-xxl flex-grow-1 container-p-y"> <!-- Content -->
                        ...
                        <div class="card mb-4">
                            <div class="row g-0">
                                <div class="col-md-6 p-4" style="border:1px solid lightgrey; width:50%;">
                                    <div class="text-light small fw-semibold mb-3">채팅목록</div>
                                    ...
                                    <div class="toast-container">
                                        ...
                                        <div class="row2">
	                                         <div>
	                                         	...
	                                         	<button><i class='bx bx-paper-plane'></i></button>
	                                         </div>
                                        </div>
