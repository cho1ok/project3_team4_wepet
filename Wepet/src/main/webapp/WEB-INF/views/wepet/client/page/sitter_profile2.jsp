                                ...
                                <div class="tab-pane fade active show" id="navs-pills-justified-home" role="tabpanel">
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                                ...
                                                <div class="row mt-5">
                                                    ...
                                                    <div class="col">
                                                        <div class="input-group input-group-merge">
                                                            ...
                                                            <input type="text" class="form-control" id="basic-icon-default-email" placeholder="john.doe" aria-label="john.doe" aria-describedby="basic-icon-default-email2">
															<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#smallModalNick" style="float:right;"> 관리 </button>
                                            ...
                                            <form>
                                            <div class="mt-5">
                                            	<a href="#" style="color:grey;">회원탈퇴</a>
                                            </div>
                                            </form>
...
<option value="<%=certicategory.getCerticategory_idx()%>"><%=certicategory.getCerticategory_name() %></option>
<%} %>
 --%>
</select>
                                                                                    </div>
