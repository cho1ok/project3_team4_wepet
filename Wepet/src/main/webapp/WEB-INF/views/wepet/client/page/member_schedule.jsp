	...
	<div class="layout-container"> <!-- Layout container -->
		<div class="layout-page"> <!-- Layout-page -->
			<div class="content-wrapper"> <!-- Content wrapper -->
				...
				<h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">마이페이지 /</span> 일정관리 </h4>
					...
					<form id="form1">
						<div>
							<table class="Calendar" style="width: 500px; height: 500px">
								...
								<tbody>
									<button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#calendarModal">매칭신청 기간입력</button>
								</tbody>
							</table>
						</div>
					</form>
				</div>
				<div calss="col-lg-6" style="width: 500px; height: 500px margin-left: 0px; background-color: white;">
							...
							<div class="card-body">
								<form>
									<div class="mb-3">
										...
										<input type="text" class="form-control" readonly="readonly" id="basic-default-fullname" >
									</div>
									<div class="mb-3">
										<label class="form-label" for="basic-default-company">고객성명</label> 
										<input type="text" class="form-control" readonly="readonly" id="basic-default-company" >
									</div>
									<div class="mb-3">
			...
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					<div class="modal-header">
						<h5 class="modal-title" id="exampleModalLabel">원하는 매칭기간을 설정하세요</h5>
					...
					<div class="modal-body">
						<div class="form-group">
							<input type="text" value="매칭기간설정" readonly class="form-control" id="calendar_content"> <label for="taskId" class="col-form-label">시작 날짜</label> <input type="date" class="form-control" id="calendar_start_date"> <label for="taskId" class="col-form-label">종료 날짜</label> <input type="date" class="form-control" id="calendar_end_date">
						</div>
					</div>
